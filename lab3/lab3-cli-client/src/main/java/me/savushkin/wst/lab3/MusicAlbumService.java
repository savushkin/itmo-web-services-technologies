 ...
 */
@WebServiceClient(name = "music-album-service", targetNamespace = "http://lab3.wst.savushkin.me/", wsdlLocation = "http://0.0.0.0:8080/music-album-service?wsdl")
public class MusicAlbumService
    ...
    private final static QName MUSICALBUMSERVICE_QNAME = new QName("http://lab3.wst.savushkin.me/", "music-album-service");
    ...
    public MusicAlbumWebService getMusicAlbumWebServicePort() {
        return super.getPort(new QName("http://lab3.wst.savushkin.me/", "MusicAlbumWebServicePort"), MusicAlbumWebService.class);
    }
    ...
    public MusicAlbumWebService getMusicAlbumWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab3.wst.savushkin.me/", "MusicAlbumWebServicePort"), MusicAlbumWebService.class, features);
    }
