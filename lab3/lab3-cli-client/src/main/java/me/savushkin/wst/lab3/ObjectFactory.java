 ...
 * generated in the me.savushkin.wst.lab3 package.
...
public class ObjectFactory {
    ...
    private final static QName _WSTException_QNAME = new QName("http://lab3.wst.savushkin.me/", "WSTException");
    private final static QName _FindAlbumsResponse_QNAME = new QName("http://lab3.wst.savushkin.me/", "find-albumsResponse");
    private final static QName _DeleteAlbum_QNAME = new QName("http://lab3.wst.savushkin.me/", "delete-album");
    private final static QName _UpdateAlbumResponse_QNAME = new QName("http://lab3.wst.savushkin.me/", "update-albumResponse");
    private final static QName _UpdateAlbum_QNAME = new QName("http://lab3.wst.savushkin.me/", "update-album");
    private final static QName _FindAlbums_QNAME = new QName("http://lab3.wst.savushkin.me/", "find-albums");
    private final static QName _DeleteAlbumResponse_QNAME = new QName("http://lab3.wst.savushkin.me/", "delete-albumResponse");
    private final static QName _CreateAlbumResponse_QNAME = new QName("http://lab3.wst.savushkin.me/", "create-albumResponse");
    private final static QName _GetAlbumsResponse_QNAME = new QName("http://lab3.wst.savushkin.me/", "get-albumsResponse");
    private final static QName _CreateAlbum_QNAME = new QName("http://lab3.wst.savushkin.me/", "create-album");
    private final static QName _GetAlbums_QNAME = new QName("http://lab3.wst.savushkin.me/", "get-albums");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: me.savushkin.wst.lab3
     */
    ...
    /**
     * Create an instance of {@link WstFaultException }
     */
    public WstFaultException createWstFaultException() {
        return new WstFaultException();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link WstFaultException }{@code >}}
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "WSTException")
    public JAXBElement<WstFaultException> createWSTException(WstFaultException value) {
        return new JAXBElement<WstFaultException>(_WSTException_QNAME, WstFaultException.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindAlbumsResponse }{@code >}}
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "find-albumsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "delete-album")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "update-albumResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "update-album")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "find-albums")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "delete-albumResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "create-albumResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "get-albumsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "create-album")
     ...
     */
    @XmlElementDecl(namespace = "http://lab3.wst.savushkin.me/", name = "get-albums")
