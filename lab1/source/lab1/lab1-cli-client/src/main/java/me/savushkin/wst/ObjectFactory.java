 ...
 * generated in the me.savushkin.wst package.
...
public class ObjectFactory {
    ...
    private final static QName _FindAlbumsResponse_QNAME = new QName("http://wst.savushkin.me/", "find-albumsResponse");
    private final static QName _FindAlbums_QNAME = new QName("http://wst.savushkin.me/", "find-albums");
    private final static QName _GetAlbumsResponse_QNAME = new QName("http://wst.savushkin.me/", "get-albumsResponse");
    private final static QName _GetAlbums_QNAME = new QName("http://wst.savushkin.me/", "get-albums");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: me.savushkin.wst
     */
     ...
     */
    @XmlElementDecl(namespace = "http://wst.savushkin.me/", name = "find-albumsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wst.savushkin.me/", name = "find-albums")
     ...
     */
    @XmlElementDecl(namespace = "http://wst.savushkin.me/", name = "get-albumsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wst.savushkin.me/", name = "get-albums")
