 ...
 *
 */
@WebServiceClient(name = "music-album-service", targetNamespace = "http://lab1.wst.savushkin.me/", wsdlLocation = "http://0.0.0.0:8080/music-album-service?wsdl")
public class MusicAlbumService
    ...
    private final static QName MUSICALBUMSERVICE_QNAME = new QName("http://lab1.wst.savushkin.me/", "music-album-service");
     ...
     *
     * @return
     *     returns MusicAlbumWebService
     */
    @WebEndpoint(name = "MusicAlbumWebServicePort")
    public MusicAlbumWebService getMusicAlbumWebServicePort() {
        return super.getPort(new QName("http://lab1.wst.savushkin.me/", "MusicAlbumWebServicePort"), MusicAlbumWebService.class);
    }
    ...
    public MusicAlbumWebService getMusicAlbumWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1.wst.savushkin.me/", "MusicAlbumWebServicePort"), MusicAlbumWebService.class, features);
    }
